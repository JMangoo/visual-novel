...
label act2:
    ...
    "(임시) 예고, 살인, 반복. 나는 앞서가려 했지만 매번 반 발짝 늦었다."

    # 일부러 비합리적으로 굴어본다
    menu:
        "예측을 벗어나려 일부러 엉뚱하게 행동한다":
            $ madness += 2
            "(임시) 아무도 예상 못 할 선택. 그렇게 믿었다."
        "냉정하게 다시 논리로 파고든다":
            $ madness += 1
            "(임시) 감정을 배제하면 답이 보인다. 그렇게 믿었다."
    ...
    "(임시) 뭔가 어긋나 있다. 하지만 나는 저 수상한 남자를 쫓느라, 그 어긋남을 지나쳤다."
