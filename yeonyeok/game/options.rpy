...
# 타이틀 화면 우하단에 표시된다.
# 아이폰이 캐시된 옛 빌드를 보고 있는지 구분하려고 빌드 태그를 붙였다.
# 주의: 이 값으로 빌드 폴더 이름이 만들어지므로 공백·괄호·콜론을 쓰면 빌드가 실패한다.
define config.version = "1.0-b3"
...
define config.save_directory = "yeonyeok-1784916545"
